...
const DASHBOARD_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      descriptionEn: "AI analyzes project status and auto-schedules work blocks into Outlook calendar free slots (3-day rolling)",
      status: "live",
      statusLabel: "運用中",
      statusLabelEn: "Live",
      progress: 100,
      url: null,
      detail: {
        overview: "BOF-AI-Dashboardのプロジェクトデータ（data.js）をAIが分析し、優先順位を判定。Outlook予定表の空き時間に作業予定を自動配置する3日間ローリングスケジューラー。毎朝8:00に自動実行し、状況変化に応じて予定を再評価・更新する。",
    ...
    },
    {
      ...
      progress: 85,
      detail: {
        overview: "新卒社員向けのAI研修を全3回のHTMLスライドで制作。第1回:AI基礎と安全な使い方、第2回:4つの業務場面とプロンプトの書き方、第3回:AIの業務組み込みとナレッジ資産化。",
        overviewEn: "AI training for new hires in 3 HTML slide sessions. Session 1: AI basics & safe usage. Session 2: 4 business scenarios & prompt writing. Session 3: Integrating AI into workflows & knowledge management.",
